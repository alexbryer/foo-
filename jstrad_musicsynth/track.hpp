...
public:
	...
	*/
	typedef std::list<MIDIEvent>::const_iterator ConstIteratorType;//list of the event objects
...
private:
	std::list<MIDIEvent> midilist;
	//from typedef
	//ConstIteratorType it1 = midilist.begin();
	//ConstIteratorType it2 = midilist.end();
	intmax_t tickspbeat;
	// TODO
};
